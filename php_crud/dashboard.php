...
<div class="main-content">
    <div class="page-header">
        <h1>Dashboard</h1>
        <span style="font-size:13px;color:#888;">Welcome back, <strong><?= htmlspecialchars($_SESSION['admin_user']) ?></strong></span>
    </div>
    ...
    <div class="card">
        ...
        <div style="display:flex;gap:12px;flex-wrap:wrap;">
            ...
            <a href="view_users.php" class="btn btn-success">👁️ View All Users</a>
        </div>
    </div>
